...
SchedForge 0.11 is organized as a model-to-machine CPU AI compiler. The graph,
...
- Attention is a CPU Flash-style exact lowering, not a GPU FlashAttention-2
  implementation. Paged KV and spill-free native-parity fused LLVM code remain
  future work.
