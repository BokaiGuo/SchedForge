...
SchedForge 0.6 is organized as a model-to-machine CPU AI compiler. The graph,
...
- Attention is a CPU Flash-style exact lowering, not a GPU FlashAttention-2
  implementation. Paged KV and a monolithic fused LLVM attention kernel remain future work.
