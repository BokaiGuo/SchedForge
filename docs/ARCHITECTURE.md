...
SchedForge 0.4 is organized as a model-to-machine CPU AI compiler. The graph,
...
rejoining dispatch bufferization and LoopIR lowering.
...
- The dense MLP and FP32 Top-2 MoE paths are compiled, executed, and validated end to end.
